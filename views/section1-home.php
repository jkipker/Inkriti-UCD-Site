            ...
            <div id="home" class="nav2">
                <nav id="navbar" class="bottom-nav">
                  <img class="nav-logo-btm" src="img/logo-btm-nav.png"/>
                   <ul class="menu">
                <li><div class="nav-div-home"><a class="nav-home" href="#" data-target="lookBack">Home <hr/></a></div></li>
                ...
                <div class="twitter-share-button" style="margin-left: 147px; bottom: 7px;">
                <script src="//platform.linkedin.com/in.js" type="text/javascript">
                  lang: en_US
                </script>
                <script type="IN/FollowCompany" data-id="41554" data-counter="none"></script>
                </div>
                </nav>
